...
public class Googlepage {
	...
	@Test (priority = 2,enabled = true,description = "search bar", groups = "sanity")
	...
	@Test(priority = 3,enabled = true,description = "gmail", groups = "gamilText")
	...
	@Test(priority = 4,enabled = true,description = "imfeelingluckytoclick", groups = "imfeelinglucky")
	...
	@Test(priority = 5,enabled = true,description = "click image",   groups = "imagetext")
	public void images() {
	...
	@Test(priority = 6,enabled = true,description = "click on About", groups = "click about")
	public void about() {
	...
	@Test(priority = 7,enabled = true,description = "click on Advertising", groups = "click Advertising")
	...
	@Test(priority = 8,enabled = true,description = "click on Advertising", groups = "click Advertising")
	...
	@Test(priority = 9,enabled = true,description = "click on howSearchworks ", groups = "click howSearchworks")
	...
	@Test(priority = 11,enabled = true,description = "click on Privacy", groups = "click Privacy")
	public void Privacy() {
	...
	@Test(priority = 12,enabled = true,description = "click on terms", groups = "click terms")
	public void terms() {
	...
	@Test(priority = 13,enabled = true,description = "click on settings", groups = "click settings")
	...
	@AfterMethod(enabled = true,description = "close Browser", groups = "closeAll")
